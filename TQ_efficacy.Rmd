...
for(i in 1:nrow(mthb_mat)){
  ...
  f_mthb = approxfun(x = mthb_dat$time_since_dose[ind], y = mthb_dat$hgbmet[ind])
...
# 
# mod_glm_t_12 = glmer(outcome7to180 ~ t_12_terminal_rescaled + logpara0 + (1|studysite),
#                     family='binomial', data = outcome_dat[ind_sensitivity, ])
# summary(mod_glm_t_12)
# exp(fixef(mod_glm_t_12)['t_12_terminal_rescaled'])
# 
# mod_glm_t_12_tq = glmer(outcome7to180 ~ tqmgkgtot + t_12_terminal_rescaled + logpara0 + (1|studysite),
#                     family='binomial', data = outcome_dat)
# summary(mod_glm_t_12_tq)
# exp(fixef(mod_glm_t_12_tq)['t_12_terminal_rescaled'])
# 
# mod_glm_everything = glmer(outcome7to180 ~ tqmgkgtot + t_12_terminal_rescaled + day7_mthb + (1|studysite),
#                     family='binomial', data = outcome_dat)
...
mod_t_12 = glmer(outcome7to180 ~ t_12_terminal_rescaled + tqmgkgtot + (1|studysite),family='binomial', data = outcome_dat)
